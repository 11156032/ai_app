...
class AIIntentService {
  static final Map<UserIntent, Map<String, dynamic>> _intentMetadata = {
    ...
    UserIntent.addGeneric: {'label': '新增項目', 'keywords': ['新增', '新增行程或待辦', '新增項目', '幫我新增項目', '添加項目', '建立新項目']},
    UserIntent.editGeneric: {'label': '修改項目', 'keywords': ['修改', '修改行程或待辦', '修改項目', '編輯項目', '更改項目', '幫我修改項目']},
