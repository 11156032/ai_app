...
class AIIntentService {
  static final Map<UserIntent, Map<String, dynamic>> _intentMetadata = {
    ...
    UserIntent.createTodo: {'label': '新增待辦', 'keywords': ['新增待辦', '加待辦', '待辦事項', '記待辦', '寫待辦', '做什麼', '新增代辦', '加代辦', '代辦事項', '記代辦', '寫代辦', '代辦']},
    UserIntent.editItinerary: {'label': '修改行程', 'keywords': ['修改行程', '更改行程', '編輯行程', '改行程', '改時間', '修改時間', '更改時間']},
    UserIntent.editTodo: {'label': '修改待辦', 'keywords': ['修改待辦', '修改代辦', '編輯待辦', '編輯代辦', '改待辦', '改代辦', '更改待辦', '更改代辦']},
    UserIntent.addGeneric: {'label': '新增項目', 'keywords': ['新增', '加', '增加', '添加', '新增項目', '建立']},
    UserIntent.editGeneric: {'label': '修改項目', 'keywords': ['修改', '編輯', '更改', '更動', '修改項目']},
