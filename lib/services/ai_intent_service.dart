...
class AIIntentService {
  static final Map<UserIntent, Map<String, dynamic>> _intentMetadata = {
    ...
    UserIntent.addGeneric: {'label': '新增項目', 'keywords': ['新增', '增加', '添加', '建立新的', '幫我新增']},
    UserIntent.editGeneric: {'label': '修改項目', 'keywords': ['修改', '編輯', '更改', '更動', '修改項目', '幫我修改']},
    ...
    UserIntent.viewProfile: {'label': '個人檔案', 'keywords': ['個人檔案', '我的資料', '主頁', '設定頁面', '我的個人資料', '查看個人檔案']},
