...
class AppLocaleService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'faq_a9': {zhTW: '前往「個人檔案」>「自訂導覽列項目順序」，面板中提供 5 格即時動態預覽。您可以點擊任一項目卡片互相對調，或使用「▲ / ▼」箭頭微調，將最常用的 3 項功能放入底欄，其餘收合至側邊抽屜，點擊「儲存套用」立即生效。', ja: '「マイページ」>「ナビゲーションバー並び替え」から5枠のプレビューを確認できます。カードのタップ入れ替えや「▲ / ▼」矢印で順序を調整し、「保存して適用」をタップすると即時反映されます。', ko: '「마이페이지」 > 「하단 바 순서 맞춤설정」에서 5칸 실시간 미리보기를 제공합니다. 카드 탭으로 위치를 맞바꾸거나 「▲ / ▼」 버튼으로 순서를 조정한 후 「저장 및 적용」을 누르면 즉시 반영됩니다.'},
