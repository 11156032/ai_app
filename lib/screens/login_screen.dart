              ...
              children: isTerms
                  ? [
                      _buildInlineSection('1. 接受條款與服務範疇',
                          '您使用「YeBang 家教」即代表您已閱讀並同意受本條款約束。本服務提供題庫測驗、AI 詳解、能力診斷、弱項補強、個人筆記、行事曆排程與 24H 智能客服等功能。'),
                      ...
                      _buildInlineSection('4. AI 生成內容聲明',
                          'AI 智慧功能由尖端模型（含 Groq、Gemini 等）提供支援，其回覆內容為學習輔助參考資料，不構成考試唯一標準或專業法律保證。'),
                      _buildInlineSection('5. 免責聲明與管轄法院',
                          '本服務依現狀提供。條款依中華民國法律為準據法，並以台灣台北地方法院為第一審管轄法院。最後修訂：2026 年 8 月 17 日。'),
                    ]
                  : [
                      _buildInlineSection('1. 蒐集的資料類型',
                          '帳號資訊（姓名、Email）、學習歷程（測驗紀錄、正確率、錯題本、手寫與文字筆記、行事曆待辦）及系統偏好（主題、語言）。'),
                      ...
                      _buildInlineSection('5. 第三方服務供應商',
                          '整合 Google 登入、Groq AI、Google Gemini AI 及 OpenRouter 等服務，相關資料依各隱私規範與當次推理處理。最後修訂：2026 年 8 月 17 日。'),
                    ],
            ),
          ),
        ),
